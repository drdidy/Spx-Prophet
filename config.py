...
# ─── Strategy Parameters ─────────────────────────────────────────────
SLOPE = 1.04           # points per hour (all lines)
                       # = 0.52 per 30-min candle
CHANNEL_SLOPE = SLOPE  # channel lines use same slope as wick lines
NUM_LINES = 6
POSITION_SIZE_ES = 2
...
LINE_COLORS_DISPLAY = {
    "asc_ceiling": "#FF4444",       # Red — ascending channel ceiling
    "asc_floor": "#FF4444",         # Red — ascending channel floor
    "desc_ceiling": "#00FF88",      # Green — descending channel ceiling
    "desc_floor": "#00FF88",        # Green — descending channel floor
    "hw_ascending": "#a0a0c0",      # Silver — HW ascending (wick)
    "lw_descending": "#a0a0c0",     # Silver — LW descending (wick)
}

LINE_COLORS = {
    "asc_ceiling": "#FF4444",       # Red — ascending from red candle high at pivot HIGH
    "asc_floor": "#FF4444",         # Red — ascending from red candle low at pivot LOW
    "desc_ceiling": "#00FF88",      # Green — descending from green candle high at pivot HIGH
    "desc_floor": "#00FF88",        # Green — descending from green candle low at pivot LOW
    "hw_ascending": "#a0a0c0",      # Silver — ascending from highest bearish high in RTH
    "lw_descending": "#a0a0c0",     # Silver — descending from lowest bullish low in RTH
}

LINE_LABELS = {
    "asc_ceiling": "AC ↗",         # Ascending Channel Ceiling
    "asc_floor": "AF ↗",           # Ascending Channel Floor
    "desc_ceiling": "DC ↘",        # Descending Channel Ceiling
    "desc_floor": "DF ↘",          # Descending Channel Floor
    "hw_ascending": "HW ↗",        # High Wick ascending
    "lw_descending": "LW ↘",       # Low Wick descending
}
...
# ─── TradingView Webhook ─────────────────────────────────────────────
TV_WEBHOOK_PORT = 80    # TradingView only allows port 80/443
