...
/* ═══ HIDE CHROME (keep toolbar & sidebar toggle visible) ═══ */
.stApp > header {{ background: transparent !important; height: auto !important; }}
#MainMenu, footer, .stDeployButton {{ display: none !important; }}
[data-testid="stToolbar"] {{ opacity: 0.35; transition: opacity 0.3s; }}
...
/* Restore Material Symbols font on icon spans inside expander summary */
