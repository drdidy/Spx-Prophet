...
SETUP IN TRADINGVIEW:
  TradingView only allows webhooks to port 80 or 443.

  OPTION A — ngrok (recommended):
    1. Install ngrok: https://ngrok.com/download
    2. Run: ngrok http 80
    3. Copy the https:// URL ngrok gives you
    4. In TradingView alert, set webhook to: https://YOUR_NGROK.ngrok.io/webhook

  OPTION B — direct (port 80, requires admin):
    1. Run Streamlit as Administrator
    2. In TradingView alert, set webhook to: http://YOUR_PUBLIC_IP/webhook
